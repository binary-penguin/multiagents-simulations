...
public class Transformations
{
    ...
    public static Matrix4x4 RotateM(float angle, AXIS axis)
    {
      ...
      /** CREAR VECTORES DE PUNTOS INICIALES Y APLICAR MATRICES DE MODELADO A **/ 
    public static Vector4 Translate(Vector4 original, float x, float y, float z)
    {
        ...
        // Internamente este * hace una multiplicacion matricial con un doble for
        return t * original;
    }
